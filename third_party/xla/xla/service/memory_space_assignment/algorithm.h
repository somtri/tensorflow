...
class MsaAlgorithm : public GlobalDecreasingSizeBestFitHeap<HloValue> {
 ...
 private:
  ...
  void CreatePinnedAllocationsInAltMemoryForPositions(
      ...
      // end of the program). Note: extending a scalar buffer's live range via
      // this override is an artificial hack and should generally be avoided;
      // when nullopt, the exact true live range end time computed by
